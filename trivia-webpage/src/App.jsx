...
function App() {
    return (
        ...
        <div className="trivia-app">
            ...
            <BrowserRouter>
                <div className="navbar bg-base-1000 flex items-center justify-center" style={{ height: '3rem', marginTop: '0px', position: 'relative', overflow: 'hidden', backgroundImage: 'linear-gradient(to right, #ff5d6c 47%, #646CFF 53%)' }}>
